...
pipeline {
    ...
    parameters {
        ...
        string(defaultValue: 'CoreHandlerPerfTest', description: 'Test Pattern to use, e.g.: CoreHandlerPerfTest, EE9ServletPerfTest, EE10ServletPerfTest, EE11ServletPerfTest', name: 'TEST_TO_RUN')
