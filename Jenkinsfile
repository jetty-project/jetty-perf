...
pipeline {
    ...
    parameters {
        ...
        string(defaultValue: 'CometdBenchmark2Test', description: 'Test Pattern to use, e.g.: CoreHandlerPerfTest, EE9ServletPerfTest, EE10ServletPerfTest, EE11ServletPerfTest', name: 'TEST_TO_RUN')
        ...
        string(defaultValue: '', description: 'The CometD clients benchmark command line', name: 'COMETD_CLIENTS_CMDLINE')
        string(defaultValue: '', description: 'The CometD server benchmark command line', name: 'COMETD_SERVER_CMDLINE')
    }
    //tools {
    //    jdk "${JDK_TO_USE}"
    //}
