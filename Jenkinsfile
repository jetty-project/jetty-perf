...
pipeline {
    ...
    parameters {
        ...
        string(defaultValue: 'ASYNC_PROF_JFR_CPU', description: 'Extra monitored items, as a CSV string.' +
            ' You can choose from this list: GC_LOGS, SJK_TTOP, ASYNC_PROF_CPU, ASYNC_PROF_ALLOC, ASYNC_PROF_LOCK, ASYNC_PROF_CACHE_MISSES, ASYNC_PROF_JFR_CPU, ASYNC_PROF_JFR_CPU_ALLOC', name: 'OPTIONAL_MONITORED_ITEMS')
