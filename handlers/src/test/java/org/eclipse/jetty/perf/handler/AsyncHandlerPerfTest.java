...
public class AsyncHandlerPerfTest
{
    ...
    private static Stream<PerfTestParams> params()
    {
        ...
        return Stream.of(
            new PerfTestParams(PerfTestParams.Protocol.http, 60_000, 100, 5_000, 625_000, 10.0),
            new PerfTestParams(PerfTestParams.Protocol.https, 60_000, 100, 6_500, 1_000_000, 10.0),
            new PerfTestParams(PerfTestParams.Protocol.h2c, 60_000, 100, 13_000, 700_000, 15.0),
            new PerfTestParams(PerfTestParams.Protocol.h2, 60_000, 100, 75_000, 1_000_000, 15.0)
        );
    }
